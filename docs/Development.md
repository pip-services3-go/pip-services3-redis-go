# Development and Testing Guide <br/> Pip.Services Redis for Golang
...
If you are planning to develop and test you may need to install Redis servers

## <a name="install"></a> Installing

After your environment is ready you can check out source code from the Github repository:
```bash
git clone git@github.com:pip-services/pip-services-redis-go.git
```
